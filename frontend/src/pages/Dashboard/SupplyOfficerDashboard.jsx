  ...
  const priorityTasks = [
    {
      ...
      items: ['Office Chairs (5)', 'Projector (2)', 'Printer Ink (5)']
    },
    {
      ...
      items: ['Laptop (3)', 'Camera (2)', 'Tablet (3)']
    },
    {
      ...
      color: 'error',
      path: '/inventory',
      items: ['Printer Paper', 'Toners', 'Markers']
    },
    {
      ...
      color: 'success',
      path: '/inventory',
      items: ['Desks', 'Chairs', 'Monitors']
    },
  ];

  const recentRequests = [
    { id: 'PR-001', item: 'Office Chairs', requester: 'John Doe', date: '2 hours ago', status: 'pending' },
    { id: 'BR-045', item: 'Projector', requester: 'Jane Smith', date: '5 hours ago', status: 'approved' },
    { id: 'PR-002', item: 'Printer Ink', requester: 'Mike Johnson', date: '1 day ago', status: 'pending' },
    { id: 'BR-046', item: 'Laptop', requester: 'Sarah Wilson', date: '1 day ago', status: 'rejected' },
  ];
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <Box sx={{ flex: 1 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
                              ...
                              <Chip 
                                label={request.id.startsWith('PR') ? 'Purchase' : 'Borrow'} 
                                size="small"
                                color={request.id.startsWith('PR') ? 'primary' : 'secondary'}
                              />
                            </Box>
              ...
              <CardContent>
                ...
                <Box sx={{ mt: 4, p: 2, bgcolor: 'grey.50', borderRadius: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Typography variant="body2" fontWeight="bold" color="warning.main">12</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
